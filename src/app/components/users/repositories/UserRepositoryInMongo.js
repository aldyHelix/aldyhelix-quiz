...
const User = require('./interface/UserModelInterface');
const MongooseUser = require('../models/UsersModel');
const UserRepository = require('./interface/UserRepositoryInterface');
