const AccessTokenManager = require('../../../../src/app/security/AccessTokenManager');
const mockAccessTokenManager = new AccessTokenManager();
const VerifyAccessToken = require('../../../../src/app/components/users/services/VerifyAccessToken');
